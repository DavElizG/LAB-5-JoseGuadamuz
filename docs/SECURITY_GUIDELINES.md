# SECURITY GUIDELINES - LAB-5-UNACHAT

## Introducción

Este documento establece el estándar de desarrollo seguro y de calidad para el proyecto **LAB-5-UNACHAT**, una aplicación web desarrollada con Node.js y Express. 
...
La estructura del proyecto **LAB-5-UNACHAT** debe seguir el siguiente estándar:
...
Cada miembro del equipo de **LAB-5-UNACHAT** se compromete a:
...
Este documento ha sido revisado y aprobado por el equipo de desarrollo de **LAB-5-UNACHAT** como parte de la **Fase 1 del SSDLC (Planificación y Diseño Seguro)** en el curso de Seguridad Informática.

| Nombre | Rol | Firma | Fecha |
|--------|-----|-------|-------|
|    Norman alvarado   | Desarrollador/a |       | 05/11/2025 |
|    Melina Cruz    | Desarrollador/a |       | 05/11/2025 |
|    Jose Guadamuz   | Desarrollador/a |       | 05/11/2025 |
|    Marco Jiménez    | Desarrollador/a |       | 05/11/2025 |
...
**Versión**: 1.0  
**Fecha de creación**: 05 de noviembre de 2025  
**Última actualización**: 05 de noviembre de 2025  
**Estado**: Aprobado

---

*Este documento es un componente crítico del Secure Software Development Life Cycle (SSDLC) del proyecto LAB-5-UNACHAT y debe ser revisado y actualizado regularmente para reflejar las mejores prácticas actuales de seguridad.*